...
<%
  ...
  Collection<DTTipoRegistro> tiposRegistro = (Collection<DTTipoRegistro>) request.getAttribute("tiposRegistro");
  Collection<DTPatrocinio> patrocinios = (Collection<DTPatrocinio>) request.getAttribute("patrocinios");
