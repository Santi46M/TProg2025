 ...
 * 
 */
@WebServiceClient(name = "PublicadorUsuarioService", targetNamespace = "http://publicadores/", wsdlLocation = "http://192.168.56.1:8090/publicadorUsuario?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://192.168.56.1:8090/publicadorUsuario?wsdl");
