...
public class AltaEdicionEvento extends JInternalFrame {
    public AltaEdicionEvento(String[] eventos, String[] organizadores) {
        ...
        JComboBox<String> comboEvento = new JComboBox<>(eventos);
        ...
        JComboBox<String> comboOrganizador = new JComboBox<>(organizadores);
        ...
        btnAceptar.addActionListener(ev -> {
            ...
            String organizador = (String) comboOrganizador.getSelectedItem();
            ...
            if (evento == null || organizador == null || nombre.isEmpty() || sigla.isEmpty() || ciudad.isEmpty() || pais.isEmpty() || fechaInicio.isEmpty() || fechaFin.isEmpty() || fechaAlta.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Todos los campos deben estar completos.");
                return;
            }
            JOptionPane.showMessageDialog(this,
                    "Edición registrada con éxito:\nEvento: " + evento +
